            ...
            <div class="container-fluid mimin-wrapper">
                    ...
                    <div class="sub-left-menu scroll">
                        <ul class="nav nav-list">
                            ...
                            <li class="ripple">
                                ...
                                <ul class="nav nav-list tree">
                                    <li><a href="../lojas/centauro.php">CENTAURO</a></li>
                ...
                <div id="responsive">
                    <center>
                        ...
                        <h1 style="margin: 15px; font-weight: 500; font-family: 'open sans', 'Helvetica Neue', 'Helvetica', 'Arial', 'sans-serif' font-size: 40px; color: #DADEE0;">CHECKER - BOL
				   </h1>
